...
var ParametricGenerator_1 = __importDefault(require("./generators/ParametricGenerator"));
var Graph_1 = __importDefault(require("./graph/Graph"));
var fs = require("node:fs/promises");
var TrainingDataBuilder = /** @class */ (function () {
    function TrainingDataBuilder() {
        this.trainingDataInput = [];
        this.trainingDataExpected = [];
        this.parametricGenerator = new ParametricGenerator_1.default();
    }
    TrainingDataBuilder.prototype.generateTrainingData = function () {
        ...
        while (this.parametricGenerator.iterate()) {
            var fitnessValue = this.parametricGenerator.calculateFitnessValueForCurrentIteration();
    ...
    TrainingDataBuilder.prototype.save = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fs.writeFile(path, JSON.stringify(data, null, 3))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    TrainingDataBuilder.prototype.read = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var data, json, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = TrainingDataBuilder;
